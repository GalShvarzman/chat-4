    ...
    public render() {
        return (
            <div className='container'>
                <div className='textarea-wrapper'><textarea className='message-textarea' value={this.props.message['message']} disabled={!this.props.data.loggedInUser || !this.props.selected} onKeyDown={this.props.keyDownListener} onChange={this.props.handleChange} placeholder="Type a message"/></div>
